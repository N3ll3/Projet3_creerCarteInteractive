class Station {
  constructor(
    ...
    this.bikeIconIsOpen = this.createIcon(
      "js/leaflet/images/marker-icon-bike.png"
    );
    this.bikeIconIsClosed = this.createIcon(
      "js/leaflet/images/marker-icon-closed.png"
    );
    this.bikeIconIsLimit = this.createIcon(
      "js/leaflet/images/marker-icon-limitbike.png"
    );
    this.bikeIconIsFull = this.createIcon(
      "js/leaflet/images/marker-icon-fullbike.png"
    );
